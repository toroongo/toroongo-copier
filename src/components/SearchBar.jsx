...
const SearchBar = ({
  ...
  return (
    <div className="z-30 md:sticky md:top-[79px]">
      <div className="mx-auto max-w-7xl px-4 pt-4">
        <div className="rounded-2xl border border-primary/15 bg-white/80 px-3 py-3 shadow-soft backdrop-blur-xl md:px-4">
          ...
          {/* Desktop: category pills and sort/clear share a single row */}
